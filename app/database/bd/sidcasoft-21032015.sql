...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2015 a las 06:04:56
...
INSERT INTO `proyecto` (`idProyecto`, `nombre`, `descripcion`, `idCliente`, `idEmpresa`, `titulo`, `fechaInicio`, `fechaFin`, `idRecMat`, `idProceso`, `costoTotal`, `status`, `fechaIncial`, `fechaFinal`, `updated_at`, `created_at`) VALUES
(1, 'Sistema Gestion de Indicadores', 'Los indicadores clave de rendimiento (KPI) ayudan a las empresas a entender lo bien que se está realizando el trabajo en relación con sus metas y objetivos estratégicos. En un sentido más amplio, un KPI proporciona la información de rendimiento más importante que permite a las partes interesadas saber si se va por buen camino.', 1, 2, 'KPI', '2014-10-26', '2015-11-30', 1, 1, 500, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2015-03-22 00:39:53', '0000-00-00 00:00:00'),
(2, 'Sistema de control de Inventarios', 'Son destinatarias directas tanto las organizaciones solidarias como las personas a las que se invita a participar, en este caso, la población de Bizkaia; y son destinatarias indirectas las personas usuarias de los programas desarrollados por las entidades.', 1, 3, 'Proyecto 2', '2014-10-27', '0000-00-00', 1, 1, 1000, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2015-03-22 00:39:56', '0000-00-00 00:00:00'),
(3, 'ERP', 'Bootstrap easily and efficiently scales your websites and applications with a single code base, from phones to tablets to desktops with CSS media queries.', 1, 4, 'Proyecto 3', '2014-10-27', '0000-00-00', 1, 1, 1500, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2015-03-22 00:40:09', '0000-00-00 00:00:00'),
(4, 'Sidcasoft', 'Proyecto para el contol de proyectos software', 1, 1, 'Sidcasoft', '2015-03-18', '2015-12-12', 1, 2, 10000, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2015-03-22 00:40:12', '0000-00-00 00:00:00'),
(5, 'Proyecto XYZ', 'Esto es una prueba creada por Luis Eduardo Villela y modificada por él mismo', 1, 1, 'Prueba modificada', '2015-05-23', '2015-07-02', 1, 1, 1000000, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2015-03-17 01:41:50', '2015-03-06 11:25:51'),
(6, 'Proyecto DEF', 'Esto es una prueba del proyecto nuevo con una empresa asignada', 8, 5, 'Proyecto DEF', '2015-03-17', '2015-03-21', 1, 1, 100, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2015-03-17 09:12:12', '2015-03-17 09:12:12'),
(7, 'Sistema de cargas', 'Mejoras al sistema de cargas del ITC', 3, 1, 'Sistema de cargas', '2015-04-02', '0000-00-00', 1, 1, NULL, 1, '0000-00-00 00:00:00', NULL, '2015-03-22 08:07:47', '2015-03-22 08:07:47');
...
(10, 'Carolina', '123456789', 'Carolina Russell', 0, 'Ruben Jaramillo', '6677112233', '2015-03-13 12:11:45', '2015-03-13 12:11:45', NULL, 1, 'carolinarusssell.cr@gmail.com');
...
ALTER TABLE `proyecto`
 ADD PRIMARY KEY (`idProyecto`), ADD KEY `idCliente` (`idCliente`), ADD KEY `idRecMat` (`idRecMat`), ADD KEY `idProceso` (`idProceso`), ADD KEY `idEmpresa` (`idEmpresa`), ADD KEY `idEmpresa_2` (`idEmpresa`);
...
--
ALTER TABLE `proyecto`
MODIFY `idProyecto` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
