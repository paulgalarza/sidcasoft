...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2015 a las 21:28:22
...
(12, 'Michelle', '123', 'Michelle Soots', 1, 'Culiacan', '6677778899', '2015-04-17 00:47:09', '2015-04-17 00:47:09', NULL, 6, 'michelle@soots.com', NULL),
...
ALTER TABLE `usuarios`
 ADD PRIMARY KEY (`idUsuario`), ADD UNIQUE KEY `ProyectoAsignado` (`ProyectoAsignado`), ADD KEY `idTipoUsuario` (`idTipoUsuario`);
...
ADD CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`ProyectoAsignado`) REFERENCES `proyecto` (`idProyecto`);
